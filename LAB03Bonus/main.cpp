...
int main()
{
    ...
    //cout << "losowe Probkowanie" << endl;
    //for(int j=0; j<25;j++) {
        //for (int i =0; i < 20; i++) {
            start = clock();
            //wynik = losoweProbkowanie(Matyas_function, dziedzina1, 1000);
    ...
    avgTime = 0;
    avgLowest =0;
    cout << "wspinaczkowy" << endl;
    //for(int j = 0; j<25; j++) {
        //for (int o =0; o < 20; o++) {
            start = clock();
            wynik = wspinaczkowy(Matyas_function, dziedzina1, 1000);
            //avgLowest = avgLowest + wynik.at(0);
            end = clock();
            time_of_run = ((double)(end - start)) / CLOCKS_PER_SEC;
            //avgTime = avgTime + time_of_run;
    ...
    avgTime = 0;
    avgLowest = 0;
    //cout << "algorytm wyzazanie" << endl;
    //for(int j  = 0; j<25; j++) {
        //for (int u = 0; u < 20; u++) {
            start = clock();
            //wynik = wyzazanie(Matyas_function, dziedzina1, 1000);
            //avgLowest = avgLowest + wynik.at(0);
            end = clock();
            time_of_run = ((double)(end - start)) / CLOCKS_PER_SEC;
            //avgTime = avgTime + time_of_run;
